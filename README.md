This is online shopping system built with react for the frontend and node api for the backend. Download it or clone it to you computer, go to proejct each folder and run npm install which
